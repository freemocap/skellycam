...
mkdir -p skellycam/api/grpc/grpc_generated
...
touch skellycam/api/grpc/grpc_generated/__init__.py

# Fix imports in generated files
sed -i 's/import skellycam_pb2/from . import skellycam_pb2/' skellycam/api/grpc/grpc_generated/skellycam_pb2_grpc.py
