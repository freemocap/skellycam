...
description: How SkellyCam streams synchronized multi-camera frames over WebSocket with single-camera semantics.
---
...
For full protocol details, see the [WebSocket Protocol](../websocket-protocol) reference.
