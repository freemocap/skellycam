...
[//]: # (TODO - reference the parts of the code that actuall define this protocol, both in the websocket and the numpy recarrays)
...
[//]: # (TODO - reference parts of hte UI code relevant to this stuff)
...
[//]: # (TODO - add a note that in practice, our frontend streaming still struggles to hit th 30-60 fps it SHOULD be capable of. We're working on it, and could use some help! link to the development page)
