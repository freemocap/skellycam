...
| Page | Description |
|------|-------------|
| [Getting Started](tutorial/getting-started) | Installation, first run, and basic usage |
...
| [Configuration](tutorial/configuration) | Server settings, camera config, data directories, telemetry |
| [Development](development/) | Testing, linting, CI, and contributing guidelines |
