...
| [Architecture](architecture) | Synchronization protocol, process model, data flow |
| [API Reference](api-reference) | HTTP and WebSocket endpoint documentation |
| [WebSocket Protocol](websocket-protocol) | Binary frame format, JSON messages, backpressure |
| [Configuration](configuration) | Server settings, camera config, data directories, telemetry |
| [Development](development) | Testing, linting, CI, and contributing guidelines |
| [Contributing](contributing) | How to report bugs and submit pull requests |
| [Translating](translating) | Help translate the UI into your language |
