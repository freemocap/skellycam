...
The entire frame synchronization system is a <Tip shortInfo="Operations where any delay directly degrades temporal fidelity." longInfo="SkellyCam classifies operations into hot loops (time-critical capture), hard loops (correctness-critical processing), and soft loops (best-effort UI/streaming)." href="/docs/technical/architecture#hot-hard-and-soft-loops">**hot loop**</Tip> — every operation in the capture cycle is time-critical, and any delay directly affects temporal fidelity.
