...
[//]: # (TODO - link the 'hot-loop' to the discussion of the hot/hard/soft loop in the other doc. Ideally that hoverover jargony thing we use elswewhere)
...
[//]: # ( TODO - need to add an info block for what 'atomic' means in the context of the recording thing)
