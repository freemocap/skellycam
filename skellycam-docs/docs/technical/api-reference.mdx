...
<LinkedIssues items={[
  { label: 'Clean up /cameras and /playback APIs', url: 'https://github.com/freemocap/skellycam/issues/102' },
  { label: 'Clean up /cameras API', url: 'https://github.com/freemocap/skellycam/issues/103' },
  { label: 'Clean up /playback API', url: 'https://github.com/freemocap/skellycam/issues/104' }
]} />
