...
export const DEFAULT_VERSION = '2.0.0-alpha.2';
...
export function buildAppDownloads(version: string): DownloadEntry[] {
  return [
    { os: 'windows', arch: 'x64',   fmt: 'exe',      recommended: true,  label: 'Windows Installer',              file: `skellycam_${version}_windows-x64.exe`,               size: '' },
    { os: 'macos',   arch: 'arm64', fmt: 'dmg',      recommended: true,  label: 'macOS Installer (Apple Silicon)', file: `skellycam_${version}_macos-arm64-apple-silicon.dmg`,  size: '' },
    { os: 'macos',   arch: 'x64',   fmt: 'dmg',      recommended: true,  label: 'macOS Installer (Intel)',         file: `skellycam_${version}_macos-x64-intel.dmg`,            size: '' },
    { os: 'macos',   arch: 'arm64', fmt: 'zip',      recommended: false, label: 'macOS Portable (Apple Silicon)',  file: `skellycam_${version}_macos-arm64-apple-silicon.zip`,  size: '' },
    { os: 'macos',   arch: 'x64',   fmt: 'zip',      recommended: false, label: 'macOS Portable (Intel)',          file: `skellycam_${version}_macos-x64-intel.zip`,            size: '' },
    { os: 'linux',   arch: 'x64',   fmt: 'AppImage', recommended: true,  label: 'Linux AppImage (x64)',            file: `skellycam_${version}_linux-x64.AppImage`,             size: '' },
    { os: 'linux',   arch: 'arm64', fmt: 'AppImage', recommended: true,  label: 'Linux AppImage (ARM64)',          file: `skellycam_${version}_linux-arm64.AppImage`,            size: '' },
    { os: 'linux',   arch: 'x64',   fmt: 'deb',      recommended: false, label: 'Linux .deb (x64)',                file: `skellycam_${version}_linux-x64.deb`,                  size: '' },
    { os: 'linux',   arch: 'arm64', fmt: 'deb',      recommended: false, label: 'Linux .deb (ARM64)',              file: `skellycam_${version}_linux-arm64.deb`,                 size: '' },
  ];
}

export function buildServerDownloads(version: string): DownloadEntry[] {
  return [
    { os: 'windows', arch: 'x64',   fmt: 'exe', recommended: false, label: 'Server \u2014 Windows x64',        file: `skellycam_server_${version}_windows-x64.exe`,           size: '' },
    { os: 'macos',   arch: 'arm64', fmt: 'bin', recommended: false, label: 'Server \u2014 macOS Apple Silicon', file: `skellycam_server_${version}_macos-arm64-apple-silicon`,  size: '' },
    { os: 'macos',   arch: 'x64',   fmt: 'bin', recommended: false, label: 'Server \u2014 macOS Intel',         file: `skellycam_server_${version}_macos-x64-intel`,            size: '' },
    { os: 'linux',   arch: 'x64',   fmt: 'bin', recommended: false, label: 'Server \u2014 Linux x64',           file: `skellycam_server_${version}_linux-x64`,                  size: '' },
    { os: 'linux',   arch: 'arm64', fmt: 'bin', recommended: false, label: 'Server \u2014 Linux ARM64',          file: `skellycam_server_${version}_linux-arm64`,                size: '' },
  ];
}
