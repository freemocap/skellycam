...
export const SYSTEM_HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'paragraph',
        text: 'SkellyCam provides a single <strong>x64 (64-bit)</strong> build, which works on virtually all modern Windows PCs \u2014 Intel, AMD, and Snapdragon/ARM laptops. If you have a newer Snapdragon X / Windows on ARM machine, the x64 installer still works via Microsoft\u2019s built-in emulation layer. There\u2019s only one download \u2014 you don\u2019t need to choose.',
      },
    ],
  },
];
