      ...
      <div className={styles.container}>
        ...
        {isLegacy && selectedRelease ? (
          ...
          <>
            ...
            <DownloadSection
              icon={'\u26A1'}
              title="SkellyCam Backend Server"
              subtitle={
                <>
              ...
              detailsContent="Just the camera backend server binary, no GUI. Useful for headless capture rigs, remote systems you connect to over a network, or building a custom client against the SkellyCam API. <strong>You don't need this if you downloaded the App Installer above.</strong>"
