...
#     [cam_triggers.set_ready() for cam_triggers in group_orchestrator.camera_triggers.values()]
#
...
#     group_orchestrator: CameraGroupOrchestrator = flp_setup["group_orchestrator"]
