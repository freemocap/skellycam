...
def test_recreate_camera_shared_memory(camera_config_fixture: CameraConfig) -> None:
    ...
    shm_names = camera_shm.camera_shm_dtos
...
def test_close_and_unlink(camera_config_fixture: CameraConfig) -> None:
    ...
    try:
        SharedMemoryElement.recreate(shm_name=camera_shm.camera_shm_dtos.image_shm_name,
    ...
    try:
        SharedMemoryElement.recreate(shm_name=camera_shm.camera_shm_dtos.metadata_shm_name,
