...
@pytest.mark.asyncio
async def test_connect_with_camera_configs(controller_fixture: Controller,
...
@pytest.mark.asyncio
async def test_connect_without_camera_configs(controller_fixture: Controller,
...
@pytest.mark.asyncio
async def test_start_camera_group(controller_fixture: Controller):
    with patch.object(CameraGroup, 'start', new_callable=AsyncMock) as mock_start:
...
@pytest.mark.asyncio
async def test_close(controller_fixture: Controller):
