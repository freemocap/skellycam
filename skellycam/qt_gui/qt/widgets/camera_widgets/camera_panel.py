...
from skellycam.qt_gui.qt.widgets.camera_widgets.camera_grid_view import CameraViewGrid
from skellycam.qt_gui.qt.widgets.recording_control_panel.recording_panel import RecordingPanel
