...
from skellycam.qt_gui.qt.utilities.colors_utilities import rgb_color_generator, get_next_color
...
class LoggingQueueListener(QThread):
    ...
    def __init__(self, logging_queue: Queue, exit_event: multiprocessing.Value, parent=None):
        super().__init__(parent)
        self._logging_queue = logging_queue
        self._global_kill_flag = exit_event
        self._parent = parent
...
class LogViewWidget(QPlainTextEdit):
    ...
    def __init__(self, global_kill_flag: multiprocessing.Value,
        ...
        self._logging_queue_listener = LoggingQueueListener(
            logging_queue=self._logging_queue, exit_event=self._global_kill_flag, parent=self
        )
