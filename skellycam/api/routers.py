from skellycam.api.http.cameras.cameras_close_router import close_cameras_router
from skellycam.api.http.cameras.cameras_configs_router import camera_configs_router
