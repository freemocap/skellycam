...
from skellycam.api.routes.websocket.ipc import get_frame_wrangler_pipe
...
class CameraGroup:
    def __init__(
        ...
        self._frontend_pipe = get_frame_wrangler_pipe()  # Queue messages will be relayed through the frontend websocket
