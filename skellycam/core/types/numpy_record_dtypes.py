...
CAMERA_TIMESTAMPS_CSV_ROW_DTYPE = np.dtype([
    ...
    ('frame.pre_grab.ns', np.int64),
    ('frame.post_grab.ns', np.int64),
    ('frame.pre_retrieve.ns', np.int64),
    ('frame.post_retrieve.ns', np.int64),
    ('frame.pre_copy_to_camera_shm.ns', np.int64),
    ('frame.post_copy_to_camera_shm.ns', np.int64),
    ('frame.pre_record_frame.ns', np.int64),
    ('frame.post_record_frame.ns', np.int64),
...
MULTI_FRAME_TIMESTAMP_CSV_ROW = np.dtype([
    ...
    ('frame.pre_grab.ms.mean', np.float64),
    ('frame.pre_grab.ms.median', np.float64),
    ('frame.pre_grab.ms.standard_deviation', np.float64),
    ('frame.pre_grab.ms.range', np.float64),
    ('frame.pre_grab.proportion.coefficient_of_variation', np.float64),

    ('frame.post_grab.ms.mean', np.float64),
    ('frame.post_grab.ms.median', np.float64),
    ('frame.post_grab.ms.standard_deviation', np.float64),
    ('frame.post_grab.ms.range', np.float64),
    ('frame.post_grab.proportion.coefficient_of_variation', np.float64),

    ('frame.pre_retrieve.ms.mean', np.float64),
    ('frame.pre_retrieve.ms.median', np.float64),
    ('frame.pre_retrieve.ms.standard_deviation', np.float64),
    ('frame.pre_retrieve.ms.range', np.float64),
    ('frame.pre_retrieve.proportion.coefficient_of_variation', np.float64),

    ('frame.post_retrieve.ms.mean', np.float64),
    ('frame.post_retrieve.ms.median', np.float64),
    ('frame.post_retrieve.ms.standard_deviation', np.float64),
    ('frame.post_retrieve.ms.range', np.float64),
    ('frame.post_retrieve.proportion.coefficient_of_variation', np.float64),
    ...
    ('frame.pre_record_frame.ms.mean', np.float64),
    ('frame.pre_record_frame.ms.median', np.float64),
    ('frame.pre_record_frame.ms.standard_deviation', np.float64),
    ('frame.pre_record_frame.ms.range', np.float64),
    ('frame.pre_record_frame.proportion.coefficient_of_variation', np.float64),

    ('frame.post_record_frame.ms.mean', np.float64),
    ('frame.post_record_frame.ms.median', np.float64),
    ('frame.post_record_frame.ms.standard_deviation', np.float64),
    ('frame.post_record_frame.ms.range', np.float64),
    ('frame.post_record_frame.proportion.coefficient_of_variation', np.float64),
