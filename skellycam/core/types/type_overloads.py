...
FrameNumberInt = int | np.integer
MultiframeTimestampFloat = float | np.floating  # Mean timestamp of a multiframe (converted to milliseconds)
...
WorkerType = threading.Thread | multiprocessing.Process
