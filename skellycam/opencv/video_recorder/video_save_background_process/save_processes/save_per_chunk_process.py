...
def save_per_chunk_process(frame_lists_by_camera: Dict[str, List[FramePayload]],
    ...
    while True:
        ...
        for camera_id, frame_list in frame_lists_by_camera.items():
            ...
            if not currently_recording_frames.value and frame_list_length > 1:
                ...
                if save_all_at_the_end:
                    video_recorders[camera_id] = VideoRecorder(video_file_save_path=video_save_paths[camera_id])
