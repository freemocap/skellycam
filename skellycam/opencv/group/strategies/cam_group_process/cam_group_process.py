...
from skellycam.opencv.group.strategies.cam_group_process.internal_capture_process import (
...
class CameraIsReady:
    ...
    def all_ready(self):
        for key, value in self._cam_ready:
            if not value:
                return False
...
class CamGroupProcess:
    def __init__(
        ...
        self._cam_ready_manager = CameraIsReady()
    ...
    def start_capture(self):
        ...
        logger.debug(f"{self.camera_ids} are now capturing frames.")
