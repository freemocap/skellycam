...
from skellycam.opencv.group.strategies.grouped_process.cam_group_process.shared_memory.internal_capture_shared_memory_process import (
    InternalCaptureSharedMemoryProcess,
)
...
class CamGroupSharedMemoryProcess:
    ...
    def start_capture(self):
        ...
        self._process = InternalCaptureSharedMemoryProcess(
...
if __name__ == "__main__":
    p = CamGroupSharedMemoryProcess(camera_ids=["0"])
    p.start_capture()
