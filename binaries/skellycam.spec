...
PACKAGE_ROOT_PATH = os.path.dirname(os.path.dirname(__file__))

OUTPUT_DIST_PATH = os.path.join(PACKAGE_ROOT_PATH, 'dist')
WORK_BUILD_PATH = os.path.join(PACKAGE_ROOT_PATH, 'build')

SHARED_RESOURCES_PATH = os.path.join(PACKAGE_ROOT_PATH, 'shared', 'skellycam-logo')
SKELLYCAM_SVG_PATH = os.path.join(SHARED_RESOURCES_PATH, 'skellycam-logo.svg')
SKELLYCAM_ICO_PATH = os.path.join(SHARED_RESOURCES_PATH, 'skellycam-favicon.ico')
SKELLYCAM_MAIN_PATH = os.path.join(PACKAGE_ROOT_PATH, 'skellycam', '__main__.py')
UI_HTML_PATH = os.path.join(PACKAGE_ROOT_PATH, 'skellycam', 'api', 'http', 'ui', 'ui.html')
